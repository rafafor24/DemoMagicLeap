...
namespace MagicLeap
{
    ...
    public class MeshingExample : MonoBehaviour
    {
        ...
        [SerializeField, Space, Tooltip("Prefab to shoot into the scene.")]
        private GameObject _shootingPrefab2;
        ...
        private const float MIN_BALL_SIZE = 0.5f;
        private const float MAX_BALL_SIZE = 1.5f;
        private const int BALL_LIFE_TIME = 200;
        ...
        void Awake()
        {
            ...
            if (_shootingPrefab == null || _shootingPrefab2 == null)
            {
